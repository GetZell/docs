...
<Steps>
  ...
  <Step title="Select a Persona">
    Choose from your existing personas. Group labels appear beside each persona so you can quickly identify the right one. The persona provides the background and context for how the bot will behave.
